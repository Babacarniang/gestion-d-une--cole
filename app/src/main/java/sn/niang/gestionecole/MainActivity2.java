...
public class TerminalS2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String listItemArray [] = { "PENDA SARR" , "SALIOU SENE" , "MAMADOU DIOP" ,};
        ...
        myClasslist.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Toast.makeText(TerminalS2.this, "Liste des élèves: "+listItemArray[position], Toast.LENGTH_LONG).show();
            }
        });
